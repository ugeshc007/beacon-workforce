...
import { BarChart3, Users, DollarSign, Briefcase, TrendingUp, Clock, CalendarX, AlertTriangle, UserCheck, CalendarDays, MapPin } from "lucide-react";
...
const reports = [
  ...
  { title: "Site Visits", description: "Visits by status, conversion rate, top employees, and full visit log.", icon: MapPin, path: "/reports/site-visits", color: "text-brand bg-brand/10" },
