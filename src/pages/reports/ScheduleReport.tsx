      ...
      tables: [
        {
          ...
          headers: ["Date", "Project", "Time", "Tasks", "Team Members", "Location"],
          rows: data.dailyOverview.map((r) => [r.date, r.project, r.shiftStart && r.shiftEnd ? `${r.shiftStart.slice(0,5)}–${r.shiftEnd.slice(0,5)}` : "—", r.tasks.join("; ") || "—", r.teamNames.join(", "), r.location]),
        },
        {
